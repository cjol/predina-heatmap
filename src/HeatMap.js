...
export default class SimpleMapPage extends React.Component {
	...
	static defaultProps = {
		center: { lat: heatmapData[ 0 ][ 0 ], lng: heatmapData[ 0 ][ 1 ] },
		zoom: 13
	};
	...
	render() {
		...
		return (
			<div style={{
				...
				<GoogleMap
					bootstrapURLKeys={{
						key: "AIzaSyBrHnamVKGI2E-ZJ33HVtbLcefIaKijwbA",
					...
					onGoogleApiLoaded={( { map, maps } ) => {
						...
						this.heatmap = new maps.visualization.HeatmapLayer(
							{
								data: getPoints().map( p => new maps.LatLng( p.lat, p.lng ) ),
								map: map,
								dissipating: true,
								gradient: [ 'rgba(0, 255, 255, 0)', "#8bc34a", "#8bc34a", "#00bcd4", "#00bcd4", "#ff9900", "#ff9900", "#e91e63" ],
								radius: 20,
							}
						);
